...
const MapScreen = ({ navigation }) => {
  ...
  const stores = [
    { id: '1', name: 'Pizza Delight', distance: '5 km', image: require('../../assets/images/store1.jpg') },
    { id: '2', name: 'Bake House', distance: '10 km', image: require('../../assets/images/store2.jpg') },
    { id: '3', name: 'Fresh Mart', distance: '2 km', image: require('../../assets/images/store3.jpg') },
    { id: '4', name: 'Electro World', distance: '7 km', image: require('../../assets/images/store4.jpg') },
  ];
